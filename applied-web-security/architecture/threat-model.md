...
Data flows и TB1–TB4 са в [system-overview](system-overview.md). Разширете схемата с attacker capabilities и мястото на control-а; не маркирайте всяка Java функция като отделен trust boundary.
