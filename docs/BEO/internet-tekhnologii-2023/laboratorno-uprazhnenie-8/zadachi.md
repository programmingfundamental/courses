...
nav_order: 4
---
1\.      Приложението да се разшири, като се добави DTO за филтриране на входящи данни за отчети и крайна точка за филтрация в ReportController. В DTO класа да се осигури валидация на следните полета:
...
- Крайната дата трябва да е в бъдещето, да е след началната дата и да не е null (LocalDateTime to).
