...
Всички колекции, наследяващи Collection, имплементират интерфейса **Iterable**, което позволява използването на **foreach**. 

За по-гъвкаво обхождане се използва интерфейсът **Iterator**.
