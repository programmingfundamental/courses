...
*Забележка:* В практиката често се използват предваритено дефинирании конвенции за именуване и организация на проектите. Те позволяват различни инструменти автоматично да анализират, компилират, тестват и оценяват програмния код. Поради тази причина и в рамките на курса се използва единна структура на пакетите.
