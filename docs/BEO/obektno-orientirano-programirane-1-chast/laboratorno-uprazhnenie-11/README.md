...
- [Map и асоциативни колекции](map-i-asociativni-kolekcii.md)
  ...
  - [Map не наследява Collection](map-i-asociativni-kolekcii.md#map-не-наследява-collection)
  - [Методи за работа с Map](map-i-asociativni-kolekcii.md#методи-за-работа-с-map)
  - [Основни операции](map-i-asociativni-kolekcii.md#основни-операции)
  ...
  - [Подреждане по стойност](map-i-asociativni-kolekcii.md#подреждане-по-стойност)
