...
- [Входно-изходни операции в Java](vhodno-izhodni-operacii-v-java.md)
  - [Използване на `import` при входно-изходни операции](vhodno-izhodni-operacii-v-java.md#използване-на-import-при-входно-изходни-операции)
  ...
  - [Стандартни потоци](vhodno-izhodni-operacii-v-java.md#стандартни-потоци)
  - [Потоци за структурирани данни. Интерфейси DataInput и DataOutput](vhodno-izhodni-operacii-v-java.md#потоци-за-структурирани-данни-интерфейси-datainput-и-dataoutput)
...
- [Упражнения за извънаудиторна заетост](uprazhneniya-za-izvnauditorna-zaetost.md)
  ...
  - [Допълнителна задача — `Scanner`](uprazhneniya-za-izvnauditorna-zaetost.md#допълнителна-задача-scanner)
