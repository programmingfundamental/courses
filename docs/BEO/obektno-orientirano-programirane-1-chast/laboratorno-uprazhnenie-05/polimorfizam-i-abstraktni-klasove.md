...
Полиморфизъм по време на изпълнение се получава, когато изборът на предефиниран метод зависи от реалния тип на обекта. Това е свързано с наследяване и предефиниране на методи.
...
| Полиморфизъм по време на изпълнение | предефиниране на методи | по време на изпълнение |
