...
| В абстрактния клас ключова дума „abstract“ е задължителна за деклариране на метод като абстрактен         | В интерфейса ключова дума „abstract“ е по избор за деклариране на метод като абстракт   |
...
| Един абстрактен клас може да има static, final или static final променлива с всеки спецификатор за достъп | Интерфейсът може да има само public static final (константна) полета                    |
