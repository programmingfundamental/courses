...
За да се провери как програмата работи по време на изпълнение, нейното изпълнение трябва да бъде преди заподозрения код. Това става чрез задаване на точки на прекъсване. Точките на прекъсване показват редовете от код, където програмата ще бъде спряна, за да можете нейното състояние да бъде проверено.
