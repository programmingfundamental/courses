...
С помощта на дебъгера да се проследи изпълнението на програмата:
...
- Изпълнението на цикъла да бъде спряно при всяко число, чиято цяла част е четна.

## Задача 2

Да се анализира задачата и да се индентифицират грешките (без да се пренаписва целия код), така че да се изпълняват следните инструкции:
