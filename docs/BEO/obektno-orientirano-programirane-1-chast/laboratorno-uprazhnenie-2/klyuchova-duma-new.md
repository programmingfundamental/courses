...
Ключовата дума в Java „new“ :

* Използвана при създаване на инстанции на клас;
...
Тук при създаване на обекта, полетата се инициализират със стойности, предавани като аргументи.
