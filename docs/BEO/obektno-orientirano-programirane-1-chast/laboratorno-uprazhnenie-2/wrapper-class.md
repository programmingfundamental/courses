...
При създаване на обект от Wrapper Class, той съдържа поле, в което може да се съхранява **примитивна стойност**. Това позволява:
...
След Java 5 тези операции се изпълняват **автоматично**:
