...
В компактния конструктор не се присвояват ръчно стойности към полетата. След изпълнение на проверките компилаторът автоматично записва параметрите в съответните компоненти.
