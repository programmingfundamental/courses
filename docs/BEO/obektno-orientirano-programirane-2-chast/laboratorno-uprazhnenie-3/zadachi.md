...
Съставете програма, която създава автомобили, с клас директор, който дефинира реда за създаване на автомобилите. За целта ще имате нужда от:

* Интерфейс Мotion с метод void go(double mileage)
...
* Класове автомобил
  ...
  * Абстрактен клас Vehicle
    * полета
      ...
      * engine
      * transmission
      * tripComputer - кога се добавя инстанцията на автомобила?
      * gpsNavigator
  * Клас Car с:
    * наследява Vehicle
