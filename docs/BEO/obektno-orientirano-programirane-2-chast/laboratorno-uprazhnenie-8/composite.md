...
Да се разработи модел на файлова система.

Файловата система трябва да съдържа файлове и папки. Всеки файл има име и размер. Всяка папка има име и може да съдържа файлове и други папки.

Необходимо е да може да се изчислява размерът както на отделен файл, така и на цяла папка.

### Решение без използване на шаблона

Един възможен подход е файловете и папките да се реализират като напълно отделни класове.
...
При този подход клиентският код трябва да прави разлика между файлове и папки. Папката поддържа отделни колекции и отделни методи за добавяне на файлове и подпапки.

Ако в бъдеще се добави нов тип елемент, например архив, класът Folder ще трябва да бъде променен, за да поддържа новия тип.

Следователно е необходимо решение, което позволява всички елементи във файловата система да бъдат обработвани чрез общ интерфейс.
