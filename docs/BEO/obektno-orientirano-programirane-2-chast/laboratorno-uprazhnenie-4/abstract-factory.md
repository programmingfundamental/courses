...
> [!IMPORTANT]
> Abstract Factory се използва за създаване на семейства от свързани обекти. Шаблонът не е просто „още един начин за създаване на обекти“, а е подходящ когато различните продукти трябва да
> бъдат съвместими помежду си в рамките на една конкретна фабрика.
