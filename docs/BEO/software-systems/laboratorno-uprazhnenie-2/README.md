...
# Упражнение #2: Работа с контейнери за изглед (Layout Controls) в JavaFX. Създаване на графична сцена в JavaFX и Работа с FXML.
...
**3. Контейнери за изглед (Layout Controls):**
