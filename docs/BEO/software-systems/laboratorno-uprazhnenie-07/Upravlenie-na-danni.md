...
## Примерна задача: Библиотека

За демонстрация на управлението на данни да се използва каталог от книги. Всеки запис съдържа заглавие, автор, година на издаване и ISBN номер. Данните се извличат от базата и се визуализират в JavaFX интерфейс.
