...
![Варианти на активни бутони](image.png)

![Подсказка с описание и действие](image-1.png)

![Полета за въвеждане с плътен фон и с контур](image-2.png)
...
![Вертикално подреждане с Column и хоризонтално подреждане с Row](image-3.png)
...
![Два текстови елемента, подредени хоризонтално в Row](image-4.png)
