# Уеб сигурност (Приложна) — лабораторен курс
...
|---|---|---|---|
| 01 | [Среда и Threat Modeling](lab01-threat-modeling/lab01.md) | Compose, SecurityConfig | WebSecurityTest#lab01* |
| 02 | [Authentication](lab02-authentication/lab02.md) | Accounts, SecurityConfig | WebSecurityTest#lab02* |
| 03 | [Authorization и IDOR](lab03-authorization/lab03.md) | Documents.get | WebSecurityTest#lab03* |
| 04 | [Brute force защита](lab04-brute-force/lab04.md) | LoginGuard, provider | LoginGuardTest; WebSecurityTest#lab04* |
| 05 | [SQL Injection](lab05-sql-injection/lab05.md) | Documents.search | WebSecurityTest#lab05*; PostgresIT |
| 06 | [XSS](lab06-xss/lab06.md) | Web.render | WebSecurityTest#lab06* |
| 07 | [CSRF и browser security](lab07-csrf-browser-security/lab07.md) | session chain | WebSecurityTest#lab07*; CookieIT |
| 08 | [Криптография](lab08-cryptography/lab08.md) | Vault, Web.sensitive | VaultTest; WebSecurityTest#lab08* |
| 09 | [JWT security](lab09-jwt-security/lab09.md) | Tokens, tokenChain | JwtSecurityTest |
| 10 | [Интегрирана защита](lab10-security-testing/lab10.md) | целият проект | пълната suite; AuditTest |
