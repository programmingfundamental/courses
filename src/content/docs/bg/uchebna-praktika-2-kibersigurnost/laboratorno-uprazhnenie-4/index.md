...
В упражнение 3 брояхме само букви и символи, които отговарят на условия. Сега ще приложим филтриране и преобразуване, за да получим единен текст от английски букви A-Z.

## Цел на упражнението
- Премахнете интервали и препинателни знаци от текста.
- Преобразувайте малките ASCII букви в главни.
- Използвайте StringBuilder за постепенно изграждане на резултат.

## Необходими предварителни знания
String, char, for, if, ASCII диапазони, StringBuilder.append() и toString().
