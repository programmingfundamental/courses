...
Честотният анализ от упражнение 6 ни даде начин да свържем буквите с числови позиции. Сега ще използваме същото съответствие A=0 до Z=25, за да изместваме буквите с числов ключ.

## Цел на упражнението
- Преобразувайте буква A-Z в стойност от 0 до 25.
- Реализирайте encrypt() и decrypt() за Цезаров шифър.
- Разберете цикличното преминаване след Z и нормализирайте входа.

## Необходими предварителни знания
Методи, StringBuilder, цикли, масиви/индекси, остатък от деление и честотна таблица A-Z.
