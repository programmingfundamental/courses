...
Преди тази тема се изучават [абстракцията, абстрактните класове и интерфейсите](/courses/bg/obektno-orientirano-programirane-1-chast/laboratorno-uprazhnenie-04/abstrakciya-abstraktni-klasove-i-interfeisi/).
