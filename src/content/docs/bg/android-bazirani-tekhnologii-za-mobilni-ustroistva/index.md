...
Практически курс за магистри с **7 лабораторни упражнения по 135 минути**. В общия Kotlin проект **Mobile Context Monitor** ще управлявате state и lifecycle, ще съхранявате локални данни, ще работите със sensors, location и BLE и ще измервате ресурсите на приложението.
...
| 3 | [Background Execution и WorkManager](/courses/bg/android-bazirani-tekhnologii-za-mobilni-ustroistva/laboratorno-uprazhnenie-3/) | Как обработката остава надеждна при прекъсване и retry? |
...
Необходими са Kotlin, ООП, coroutines и начален опит с Android. Използват се Android Studio, Jetpack Compose, ViewModel, Flow/StateFlow, Room, DataStore и WorkManager. UI служи за управление и наблюдение на системата.
