...
./mvnw clean - изчиства всички компилирани файлове

./mvnw install - статира компилиране, изграждане и пакетиране на проекта

./mvnw package - стартира пакетиране на проекта 
...
Можете да откриете  списък на поддържаните свойства от application.properties  на уебсайта на Spring Boot:
