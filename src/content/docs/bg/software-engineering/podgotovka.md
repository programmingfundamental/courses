...
Изтеглете [учебния проект](https://github.com/programmingfundamental/courses/tree/main/software-engineering-ai) чрез Git:

```sh
git clone https://github.com/programmingfundamental/courses.git
cd courses/software-engineering-ai
```
...
Подробности: [архитектура](/courses/bg/software-engineering/materiali/architecture/system-overview/), [източници](/courses/bg/software-engineering/materiali/architecture/references/), [проверки и ограничения](https://github.com/programmingfundamental/courses/blob/main/software-engineering-ai/VALIDATION.md).

## Технологии и граници

Python 3.12, scikit-learn1.7.2, pandas2.3.3, numpy2.3.4, FastAPI0.119.1, Pydantic2.12.3, pytest, Ruff, GitHub Actions и Docker. Точните преки и транзитивни версии са в [requirements.lock](https://github.com/programmingfundamental/courses/blob/main/software-engineering-ai/ai-platform/requirements.lock); requirements.in е входният списък, не reproducible install command. Версиите са фиксиран учебен baseline, не твърдение за липса на известни vulnerabilities.
...
|---|---|---|
| 01 | [Lifecycle и процеси](/courses/bg/software-engineering/laboratorno-uprazhnenie-1/) | backlog, roadmap, DoD |
| 02 | [Requirements](/courses/bg/software-engineering/laboratorno-uprazhnenie-2/) | measurable SRS и traceability |
| 03 | [Architecture](/courses/bg/software-engineering/laboratorno-uprazhnenie-3/) | training/serving boundary и ADR |
| 04 | [Modularity](/courses/bg/software-engineering/laboratorno-uprazhnenie-4/) | modules, ports, configuration |
| 05 | [Design patterns](/courses/bg/software-engineering/laboratorno-uprazhnenie-5/) | stable orchestration/extension |
| 06 | [Testing](/courses/bg/software-engineering/laboratorno-uprazhnenie-6/) | data/model/API test strategy |
| 07 | [CI/CD](/courses/bg/software-engineering/laboratorno-uprazhnenie-7/) | automated gates и immutable release |
| 08 | [MLOps](/courses/bg/software-engineering/laboratorno-uprazhnenie-8/) | lineage, promotion, rollback |
| 09 | [Observability](/courses/bg/software-engineering/laboratorno-uprazhnenie-9/) | measurements и incident runbook |
| 10 | [Security, ethics, maintenance](/courses/bg/software-engineering/laboratorno-uprazhnenie-10/) | risk/debt register и retirement |
