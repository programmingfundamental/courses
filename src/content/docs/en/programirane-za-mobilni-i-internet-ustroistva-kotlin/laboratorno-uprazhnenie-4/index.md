...
Фигура 1 – Начален екран на Android Studio с отворен проект — Illustration unavailable in the source repository: `images/studio_main.png`.  
...
Фигура 2 – SDK Manager в Android Studio — Illustration unavailable in the source repository: `images/sdk_manager.png`.  
...
Фигура 3 – Прозорецът на AVD Manager с налични емулатори — Illustration unavailable in the source repository: `images/avd_manager.png`.  
...
Фигура 4 – Стартиран емулатор с Android устройство — Illustration unavailable in the source repository: `images/emulator_running.png`.  
...
Фигура 5 – Взаимодействие между Android Studio, SDK и Emulator — Illustration unavailable in the source repository: `images/android_components_diagram.png`.  
